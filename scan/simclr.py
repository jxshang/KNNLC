...
def main():
    ...
    # Dataset: Data Split into train and test dataset 
    ...
    # Memory Bank： Save the representation of the dataset
    # memory_bank_base: for training set 
    # memory_bank_val: for test set
    ...
    memory_bank_base.cuda(1)
    memory_bank_val = MemoryBank(len(val_dataset),
                                p['model_kwargs']['features_dim'],
                                p['num_classes'], p['criterion_kwargs']['temperature'])
    memory_bank_val.cuda(1)
    ...
    # Training： Model pretrained on train dataset (including unlabeled data, not including test data in train_al.py)
